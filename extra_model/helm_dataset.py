...
class DatasetHELM(Dataset):
    def __init__(self, path):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("D:/Project/MuCoCP2.0/Stage_5_Lariat/HELM-Triple")
        self.max_length_helm = 18
        with open('D:/Project/MuCoCP2.0/Stage_5_Lariat/dataset/binding_vocab.json', 'r', encoding='utf-8') as f:
            self.binding_vocab = json.load(f)
        with open('D:/Project/MuCoCP2.0/Stage_5_Lariat/dataset/amino_acid_vocab.json', 'r', encoding='utf-8') as f:
